...
public class Vacate implements Parcelable {
	...
	public static final Parcelable.Creator<Vacate> CREATOR = new Creator<Vacate>() {
		...
		public Vacate createFromParcel(Parcel source) {
			...
			vacate.u_name = source.readString();
	...
	public Vacate(String v_id, String u_phone, String u_name, String v_rtime, String v_term, String v_shift, String v_section, String v_reason, String v_tuser, String v_status, String v_btime, String v_etime, String v_type) {
		this.v_id = v_id;
