 ...
 *    EaseChatPrimaryMenu: main delete bar, text input, send button
 *    EaseChatExtendMenu: grid delete with image, file, location, etc
...
public class EaseChatInputMenu extends LinearLayout {
     ...
     * 
     * @return false--extend delete is on, will hide it first
     *         true --extend delete is off
     */
